    ...
    const fetchDashboardData = async () => {
      try {
        ...
        setStats({
          ...
          pending,
          shortlisted,
          recentApplications: allApplicants.slice(-10).reverse(),
          monthlyData,
          jobTypeDistribution,
          applicationTrend: allApplicants.map((_, i) => ({
            day: i + 1,
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
          ...
          <div className="flex items-center gap-3 mt-4 md:mt-0">
            <button className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-300 hover:shadow-md transition-all">
              <Download className="w-4 h-4" />
              <span className="text-sm font-medium">Export</span>
            </button>
            <button className="flex items-center gap-2 px-4 py-2 bg-[#6A38C2] text-white rounded-xl shadow-sm hover:bg-[#5b30a6] transition-all">
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs font-medium text-gray-400 dark:text-gray-500">+12%</span>
                </div>
                <div className="mt-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-8">
          ...
          <div className="lg:col-span-2 bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-bold text-gray-900 dark:text-white">Monthly Activity</h3>
              <button className="text-sm text-[#6A38C2] hover:underline">View All</button>
            </div>
            <div className="h-64">
                    ...
                    return (
                      <tr key={index} className="border-b border-gray-50 dark:border-gray-700/50 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                        ...
                        <td className="text-right">
                          <button className="text-gray-400 hover:text-[#6A38C2] transition-colors">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
          {[
            ...
            { label: 'View Companies', icon: Users, path: '/admin/companies', color: 'bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700' },
            { label: 'Analytics', icon: BarChart3, path: '#', color: 'bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700' }
          ].map((action, index) => (
            <button
              key={index}
